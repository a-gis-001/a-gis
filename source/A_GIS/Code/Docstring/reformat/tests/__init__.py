...
def test_reformat_already_compliant():
    docstring = A_GIS.Code.Docstring.init(
        text="""This is a compliant docstring.
...
def test_reformat_with_complex_punctuation():
    docstring = A_GIS.Code.Docstring.init(
        text="Dr. Smith visited Washington, D.C. yesterday. This is additional text."
    )
...
def test_reformat_single_sentence_with_newline():
    docstring = A_GIS.Code.Docstring.init(
        text="This is a single sentence with a newline character.\n"
    )
...
def test_reformat_with_code_block():
    docstring = A_GIS.Code.Docstring.init(
        text="""This is the first sentence. Here is a code block:
