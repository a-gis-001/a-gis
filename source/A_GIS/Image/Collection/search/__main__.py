...
collection = A_GIS.Image.Collection.insert(
    collection=collection, ids=image_files, encodings=encoded_images
)
results = A_GIS.Image.Collection.search(
    collection=collection, encodings=[encoded_images[0]]
)
