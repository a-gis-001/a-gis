def process_issue(issue, store_path, *, download_images=False, base_url=None):
    ...
    Args:
        ...
        base_url (str, optional): Base GitLab URL for image processing. Defaults to None.
    ...
    return {
        ...
        "images": (
            A_GIS.Dev.Metrics.process_images(
                issue, base_url, store_path, download=download_images
            )
            if base_url
            else []
        ),
